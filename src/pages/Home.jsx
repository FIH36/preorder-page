...
export default function Home() {
  ...
  useEffect(() => {
    fetch("https://ipapi.co/json/")
      ...
      .catch((err) => {
        console.error("국가 정보를 가져오는 데 실패했습니다.", err);
      });
  }, []);
  ...
  const handleBuyNow = () => {
    window.open(
      "https://stepearth.store/surl/P/799?utm_source=AInoonHP&utm_medium=botton_click&utm_c[…]ing_button_detail&utm_content=AInoonHP_floating_button_detail",
      "_blank"
    );
  };
      ...
      <Wrapper>
        ...
        {isPlaying && (
          <UsageVideo ref={videoRef} controls loop playsInline preload="none">
            <source src={`/UsageVideo_${lang}.mp4`} type="video/mp4" />
          </UsageVideo>
        )}
      </Wrapper>
    );
